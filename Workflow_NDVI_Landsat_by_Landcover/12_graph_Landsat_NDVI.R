...
ggplot(data=ndviAll[,], aes(x=yday, y=NDVI)) +
  ...
  geom_line(data=ndviAll[ndviAll$year==2024, ], aes(color="2024"), size=0.5) +
  stat_smooth(data=ndviAll[!ndviAll$year %in% c(2005, 2012, 2023, 2024), ],  aes(color="historical", fill="historical"), size=1.5, alpha=0.5, method="gam") +
  ...
  stat_smooth(data=ndviAll[ndviAll$year==2024, ], aes(color="2024", fill="2024"), size=1.25, alpha=0.5, method="gam") +
...
ggplot(data=ndviAll[ndviAll$type!="grassland",], aes(x=yday, y=NDVI)) +
  ...
  geom_line(data=ndviAll[ndviAll$year==2024 & ndviAll$type!="grassland", ], aes(color="2024"), size=0.5) +
